using Project_partB_Horbach_program;
using System;
...
namespace TestProject1
{
    ...
    public class HotelTests
    {
        ...
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var guest = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353801", new DateTime(1990, 1, 1));
            var room = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
            var day = 3;
        ...
        public void GetGuestList_ReturnsListOfRegisteredGuests()
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var guest1 = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353802", new DateTime(1990, 1, 1));
            var guest2 = new Project_partB_Horbach_program.Guest("Seyran", "Korhan", "+48538353802", new DateTime(1995, 1, 1));
            var room = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var room1 = new Project_partB_Horbach_program.Room(102, 100, RoomType.Single);
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
            var day = 3;
            hotel.AddRoom(room);
            hotel.AddRoom(room1);
        ...
        public void GetGuestList_ReturnsListOfRegisteredGuestsAfterSeveralOperations()
        {
            ...
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var guest1 = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353802", new DateTime(1990, 1, 1));
            var guest2 = new Project_partB_Horbach_program.Guest("Seyran", "Korhan", "+48536353802", new DateTime(1995, 1, 1));
            var room = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var room1 = new Project_partB_Horbach_program.Room(102, 100, RoomType.Single);
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
            var day = 3;
        ...
        public void GetRoomList_ReturnsListOfAvailableRooms()
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var room1 = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var room2 = new Project_partB_Horbach_program.Room(102, 150, RoomType.Double);
        ...
        public void GetRoomList_ReturnsListOfAvailableRoomsAfterCheckOut()
        {
            ...
            var room1 = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var room2 = new Project_partB_Horbach_program.Room(102, 150, RoomType.Double);
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353802", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
            var day = 3;
        ...
        public void GetStaffList_ReturnsListOfAvailableStaff()
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var staff1 = new Project_partB_Horbach_program.HotelStaff("Mikhael", "Dolan", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Staff);
            var staff2 = new Project_partB_Horbach_program.HotelStaff("Lara", "Doe", "+48538353802", new DateTime(1995, 1, 1), StaffPosition.Manager);
        ...
        public void GetStaffList_ReturnsEmptyListAfterRemovingStaff()
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var staff = new Project_partB_Horbach_program.HotelStaff("Mikhael", "Dolan", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Staff);
        ...
        public void CheckIn_CheckInInvalidRoom_ShouldThrowException()
        {
            ...
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var guest = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353801", new DateTime(1990, 1, 1));
            var invalidRoom = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single); // Номер не зареєстрований в готелі
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
        ...
        public void CheckIn_InvalidStaffPosition_ShouldThrowException()
        {
            ...
            var guest = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353801", new DateTime(1990, 1, 1));
            var room = new Project_partB_Horbach_program.Room(101, 100, RoomType.Single);
            var invalidStaff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Cleaner);
            var day = 3;
            hotel.AddRoom(room);
        ...
        public void RemoveStaff_InvalidRemoval_ShouldThrowException()
        {
            // Arrange
            var hotel = new Project_partB_Horbach_program.Hotel("Country", "City");
            var staff = new Project_partB_Horbach_program.HotelStaff("Staff", "Member", "+48538353801", new DateTime(1990, 1, 1), StaffPosition.Administrator);
        ...
        public void ToString_ReturnsCorrectString()
        {
            ...
            var guest1 = new Project_partB_Horbach_program.Guest("Ferit", "Korhan", "+48538353802", new DateTime(1990, 1, 1));
            var guest2 = new Project_partB_Horbach_program.Guest("Seyran", "Korhan", "+48538353802", new DateTime(1995, 1, 1));
            var staff = new Project_partB_Horbach_program.HotelStaff("Admin", "Kim", "+48538353802", new DateTime(1990, 1, 1), StaffPosition.Receptionist);
            var room1 = new Project_partB_Horbach_program.Room(101, 100, RoomType.Double);
            var room2 = new Project_partB_Horbach_program.Room(102, 100, RoomType.Double);
            var stayDuration1 = 4;
            var stayDuration2 = 3;
            guest1.Id = 1;
            guest2.Id = 2;
